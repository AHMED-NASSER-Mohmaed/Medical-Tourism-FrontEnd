...
export class SuperAdminService {
  ...
  getProfile(): Observable<UserBase> {
    return this.http
      .get<UserBase>(`${this.apiUrl}/profile`)
  ...
  addPatient(patientData: AddPatientRequest): Observable<Patient> {
    return this.http
      .post<Patient>(`${this.apiUrl}/add-patient`, patientData)
      .pipe(
        tap(() =>
          this.showToast({
            title: 'Success',
  ...
  getPatients(
    ...
    return this.http
      .get<PaginatedResponse<Patient>>(`${this.apiUrl}/patients`, { params })
      .pipe(
  ...
  addHotelProvider(
    ...
    return this.http
      .post<HotelProvider>(`${this.apiUrl}/add-hotel-provider`, providerData)
      .pipe(
        tap(() =>
          this.showToast({
            title: 'Success',
  ...
  getHotelProviders(
    ...
    return this.http
      .get<PaginatedResponse<HotelProvider>>(`${this.apiUrl}/hotel-providers`, {
        params,
      })
      .pipe(
        catchError((error) =>
  ...
  getCarRentalProviders(
    ...
    return this.http
      .get<PaginatedResponse<CarRentalProvider>>(
        `${this.apiUrl}/CarRental-providers`,
        { params }
      )
      .pipe(
        catchError((error) =>
 ...
 resetUserPassword(userId: string): Observable<void> {
    return this.http
      .post<void>(
        `${this.apiUrl}/reset-user-password/${userId}`, // userId in path
  ...
  exportProvidersToExcel(
    ...
    return this.http
      .get(`${this.apiUrl}/${providerType}-providers/export`, {
        params,
        responseType: 'blob',
      })
      .pipe(
...
approveProvider(
  ...
  const url = `${this.apiUrl}/approve-provider/${providerId}`;
  ...
  const url = `${this.apiUrl}/reject-provider/${providerId}`;
